...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/domain_available.git`).
...
Go to the [pull request page of DomainAvailable][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/domain_available/issues/new
[GitHub issues]: https://github.com/signmotion/domain_available/issues/new
[PRs]: https://github.com/signmotion/domain_available/pulls
